        ...
        {featured &&
          featured.map((feature) => (
            <div
              ...
              className="mx-auto my-4 w-11/12 cursor-pointer rounded-t-2xl border border-solid border-stone-300 shadow  duration-200 hover:scale-105 hover:rounded-2xl hover:shadow-lg sm:mx-4 sm:w-80"
