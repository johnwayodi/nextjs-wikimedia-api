        ...
        {featured &&
          featured.map((feature) => (
            <div
              ...
              className="mx-auto my-4 w-11/12 cursor-pointer rounded-t-2xl border shadow-md shadow-indigo-500/50  duration-200 hover:scale-105 hover:rounded-2xl hover:shadow-lg hover:shadow-indigo-500/50 sm:mx-4 sm:w-80"
