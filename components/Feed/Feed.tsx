...
const Feed: FC<Props> = ({ heading, featured }) => {
  ...
  return (
    <div className="w-full">
      <Title level={3} className="px-4 pt-8">
        {heading}
      </Title>
        ...
        {featured &&
          featured.map((feature) => (
            <div
              ...
              className="mx-auto my-4 w-11/12 cursor-pointer border shadow-md shadow-indigo-500/50  duration-200 hover:scale-105 hover:rounded-2xl hover:shadow-lg hover:shadow-indigo-500/50 sm:mx-4 sm:w-80"
            ...
            >
              <Image
                ...
                preview={false}
                className=" duration-200 hover:rounded-t-2xl"
                alt={feature.text}
              ...
              <div className="flex w-full flex-row items-center p-2">
                <CalendarOutlined rev={undefined} className="mr-2 text-lg" />
              ...
              <div className="flex w-full flex-row p-2">
                <FileTextOutlined
                  rev={undefined}
                  className="mr-1 mr-2 mt-1 text-lg"
                />
                <Text className="font-bold">{feature.pages.length} Pages</Text>
              </div>
            </div>
          ))}
      </div>
